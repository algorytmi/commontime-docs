...
| --- | --- | --- |
| Common Time Core | The normative specification. Authoritative version. | `1.4` |
| Common Time Core | Finnish version. The working version; English takes precedence. | `1.4` |
